...
#[test]
fn test_ap() {
    assert_eq!(0.525, ap(vec![7, 17, 9, 42, 5], vec![5, 7, 12, 42]));
}
#[test]
fn test_p_at_k() {
    assert_eq!(
    ...
    assert_eq!(0.0, p_at_k(vec![5, 3, 6, 1, 2], vec![1, 2, 5, 6, 7, 8], 0));
    assert_eq!(0.75, p_at_k(vec![5, 3, 6, 1, 2], vec![1, 2, 5, 6, 7, 8], 4));
    assert_eq!(0.5, p_at_k(vec![5, 3, 6, 1, 2], vec![1, 2, 5, 6, 7, 8], 8));
}
